        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/paneladmin/categories/create"><i class="mdi mdi-toggle-switch-off"></i>ایجاد</a></li>
                        <li><a href="/paneladmin/categories"><i class="mdi mdi-toggle-switch-off"></i>لیست</a></li>
                    </ul>
                </li>
