            ...
            <ul class="nav navbar-nav">
                        ...
                        <div class="column col-lg-2 col-md-3"><a href="category.html">{{$category->title}}</a>
                            <div>
                                <ul>
                                    ...
                                    <li><a href="category.html">{{$childCategory->title}} @if($childCategory->child->count() > 0)<span>&rsaquo;</span>@endif</a>
                                        @if($childCategory->child->count() > 0)
                                        <div class="dropdown-menu">
                                            <ul>
                                                @foreach($childCategory->child as $subCategory)
                ...
                <li class="menu_brands dropdown"><a href="#">برند ها</a>
                    <div class="dropdown-menu">
                        ...
                        <div class="col-lg-1 col-md-2 col-sm-3 col-xs-6"><a href="#"><img width="50px" height="50px" src="{{str_replace('public','/storage',$brand->image)}}" title="{{$brand->name}}" alt="{{$brand->name}}" /></a><a href="#">{{$brand->name}}</a></div>
                        @endforeach
                    </div>
                </li>
