        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-9" id="content">
                    ...
                    <form class="form-horizontal" method="post" action="{{route("client.register.sendemail")}}">
                        @csrf
                        <fieldset id="account">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" class="form-control" id="input-email" placeholder=" آدرس ایمیل را جهت دریافت رمز یکبار مصرف وارد کنید"  name="email">
                                </div>
                            </div>
