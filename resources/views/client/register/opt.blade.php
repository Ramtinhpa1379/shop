        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-9" id="content">
                    ...
                    <form class="form-horizontal" method="post" action="{{route("client.register.opt",$user)}}">
                        @csrf
                        <fieldset id="account">
                            <div class="form-group required">
                                <label for="input-email" class="col-sm-2 control-label">کد یکبار مصرف:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="input-opt" placeholder="  رمز یکبار مصرف وارد کنید"  name="opt">
                                </div>
                            </div>
